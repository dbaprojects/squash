...
| v5.32 | HC Calculator: replaced text inputs + ± button with custom numeric keypad (3×4 grid); − key toggles sign; ⌫ backspace; tapping player box switches focus; auto-advances to Player B after 2-digit entry |
