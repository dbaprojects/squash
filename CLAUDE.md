...
| v6.04 | Snail badge tooltip shows opponent name: `_snailBadges` changed Set→Map (player_id→opponent name); `_snailOpponent()` helper; tooltip reads "Too slow to challenge X — ladder reshuffled before match was played" |
